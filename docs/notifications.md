...
- **Cloud Run:** el canal Discord GCP Run recibe inicio, exito y fallo de deploy del servicio `operando-fiscal`, mas estados diario, semanal y mensual basados en la revision activa de Cloud Run, metricas reales de solicitudes/5xx, Cloud Logging y denegaciones IAM de Cloud Run.
